    ...
    public class Error
    {
        public static string String(FMOD.RESULT errcode)
        {
            switch (errcode)
            {
                ...
                case FMOD.RESULT.ERR_OUTPUT_NOHARDWARE:         return "FMOD_HARDWARE was specified but the sound card does not have the resources necessary to play it. ";
                ...
                case FMOD.RESULT.ERR_EVENT_NOTFOUND:            return "The requested Studio API object could not be found. ";
                ...
                case FMOD.RESULT.ERR_STUDIO_NOT_LOADED:         return "The specified resource is not yet loaded.";
